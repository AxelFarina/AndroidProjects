...
import com.cursosandroidant.notes.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val drawable: Drawable? = ResourcesCompat.getDrawable(resources,R.drawable.ic_delete,null)
